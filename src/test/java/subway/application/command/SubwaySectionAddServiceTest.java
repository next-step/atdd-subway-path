...
class SubwaySectionAddServiceTest {
    ...
    private final SubwaySectionAddService subwaySectionAddService = new SubwaySectionAddService(stationMapLoadByInPort, subwayLineLoadPort, subwaySectionAddPort);
