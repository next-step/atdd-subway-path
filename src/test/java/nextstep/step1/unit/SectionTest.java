...
public class SectionTest {
    ...
    void addSections_fail_distance() {
        ...
        Throwable exception =
                assertThrows(IllegalArgumentException.class, () -> 이호선.addSection(역삼_선릉_구간));
    ...
    void addSections_fail_upStationAndDownStationExistInLine() {
        ...
        // when - 구간 중간에 새로운 구간을 추가한다. (새로운 구간의 길이는 기존 구간의 길이와 같거나 더 크다)
        Throwable exception =
                assertThrows(IllegalArgumentException.class, () -> 이호선.addSection(강남_역삼_구간));
    ...
    void addSections_fail_upStationAndDownStationNotExistInLine() {
        ...
        Throwable exception =
                assertThrows(IllegalArgumentException.class, () -> 이호선.addSection(잠실_잠실나루_구간));
        // then - 예외가 발생한다.
