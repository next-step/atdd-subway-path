...
//
//        // then
//        assertThat(lineService.findLine(신분당선_ID).getSections()).hasSize(2);
//        assertThat(lineService.findLine(신분당선_ID).getSections()).contains(StationDto.from(신논현역), StationDto.from(강남역));
//    }
