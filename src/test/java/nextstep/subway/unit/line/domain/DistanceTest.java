...
public class DistanceTest {
    ...
    @DisplayName("더하기 테스트")
    @ParameterizedTest
    void add(int leftDistance, int rightDistance, int result) {
        Distance distance = new Distance(leftDistance);
        Distance thatDistance = new Distance(rightDistance);

        assertThat(distance.add(thatDistance).getValue())
            .isEqualTo(result);
    }
    ...
    @DisplayName("빼기 테스트")
    @ParameterizedTest
    void sub(int leftDistance, int rightDistance, int result) {
        Distance distance = new Distance(leftDistance);
        Distance thatDistance = new Distance(rightDistance);

        assertThat(distance.sub(thatDistance).getValue())
            .isEqualTo(result);
    }
