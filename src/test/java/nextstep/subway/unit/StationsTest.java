...
public class StationsTest {
    ...
    void findAddTypeEmptyStation() {
        ...
        assertThat(stations.findAddType(논현역, 양재역)).isEqualTo(SectionAddType.LAST);
    }
    ...
    void findAddType(Station upStation, Station downStation, SectionAddType type) {
        ...
        assertThat(stations.findAddType(upStation, downStation)).isEqualTo(type);
    }
    ...
    void addSectionException_withoutStations() {
        ...
        // then
        assertThatThrownBy(() -> {
            stations.findAddType(신사역, 양재시민의숲역);
