...
class PathFinderTest {
    ...
    void findShortestPathByDistance() {
        // given
        // 역
        StationResponse 홍대입구 = new StationResponse(1L, "홍대입구", LocalDateTime.now(), LocalDateTime.now());
        StationResponse 신촌 = new StationResponse(2L, "신촌", LocalDateTime.now(), LocalDateTime.now());
        StationResponse 이대 = new StationResponse(3L, "이대", LocalDateTime.now(), LocalDateTime.now());
        StationResponse 아현 = new StationResponse(4L, "아현", LocalDateTime.now(), LocalDateTime.now());
        StationResponse 충정로 = new StationResponse(5L, "충정로", LocalDateTime.now(), LocalDateTime.now());
        StationResponse 서강대 = new StationResponse(6L, "서강대", LocalDateTime.now(), LocalDateTime.now());
        StationResponse 공덕역 = new StationResponse(7L, "공덕역", LocalDateTime.now(), LocalDateTime.now());
