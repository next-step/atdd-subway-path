...
import static nextstep.fixture.LineFixture.createLineUpdateParams;
...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void updateLine() {
        ...
        // when
        지하철_노선_수정_요청(createLineUpdateParams("강남 2호선", "super green"), createResponse);

        // then
        ExtractableResponse<Response> response = 지하철_노선_조회_요청(createResponse);
        assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.jsonPath().getString("color")).isEqualTo("super green");
    }
