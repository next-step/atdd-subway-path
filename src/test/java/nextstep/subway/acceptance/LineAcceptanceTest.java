...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        // when
        ExtractableResponse<Response> response = 지하철_노선_생성_요청("2호선", "green", 1L, 2L, 10);
    ...
    void getLines() {
        ...
        지하철_노선_생성_요청("3호선", "orange",1L, 2L, 10);
    ...
    void getLine() {
        // given
        ExtractableResponse<Response> createResponse = 지하철_노선_생성_요청("2호선", "green", 1L, 2L, 10);
    ...
    void updateLine() {
        ...
        // when
        지하철_노선_수정_요청(createResponse.header("location"), "red");
