...
import static nextstep.subway.fixture.then.SectionThenFixture.노선구간추가시_구간거리가_기존거리보다_같거나_길다면_에러;
import static nextstep.subway.fixture.then.SectionThenFixture.노선구간추가시_모든역이_노선에_이미_존재할때_오류_검사;
import static nextstep.subway.fixture.then.SectionThenFixture.노선구간추가시_모든역이_노선에_존재하지않을때_오류_검사;
...
import static nextstep.subway.fixture.then.SectionThenFixture.지하철_노선_조회시_구간_id_순서_검사;
