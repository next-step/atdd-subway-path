...
class SectionAcceptanceTest extends AcceptanceTest {
    ...
    /**
     * Given 지하철 노선에 새로운 구간 추가를 요청 하고
     * When 기존 구간보다 거리가 더 먼 구간을 추가 하면
     * Then 구간 추가가 실패한다
     */
    ...
    /**
     * Given 지하철 노선에 새로운 구간 추가를 요청 하고
     * When 이미 상행역과 하행역이 노선에 등록된 구간을 추가 요청하면
     * Then 추가에 실패한다
     */
    ...
    /**
     * Given 지하철 노선에 새로운 구간 추가를 요청 하고
     * When 상행역과 하행역 둘 중 하나도 포함되어있지 않은 구간을 추가 요청 하면
     * Then 추가에 실패한다
     */
