...
class SectionAcceptanceTest extends AcceptanceTest {
     ...
     * Then 노선에 구간이 제거된다
     */
    @DisplayName("지하철 노선에 첫번째 구간을 제거")
    @Test
     ...
     * Then 노선에 구간이 제거된다
     * Then 기존의 두 구군이 하나의 구간으로 재배치 되고 구간의 길이가 변경된다
     */
    ...
    /**
     * When 지하철 노선이 하나인 노선에서 구간 제거를 요청 하면
     * Then 노선제거에 실패한다
     */
    @DisplayName("지하철 노선이 하나인 노선에서 구간 제거")
    @Test
    void removeLineSectionHavingOnlyOne() {
        // when
