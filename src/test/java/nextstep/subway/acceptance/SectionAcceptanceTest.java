...
class SectionAcceptanceTest extends AcceptanceTest {
    ...
    void removeLineSection() {
        ...
        // then
        노선_조회후_구간_추가된것_확인(강남역, 양재역);
    }

    private void 노선_조회후_구간_추가된것_확인(Long... stationId) {
