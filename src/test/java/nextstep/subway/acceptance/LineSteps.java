...
public class LineSteps {
    ...
    public static ExtractableResponse<Response> 지하철_최단_경로를_조회한다(Long sourceStation, Long targetStation) {
    ...
    public static int 상태코드_추출(final ExtractableResponse<Response> createResponse) {
