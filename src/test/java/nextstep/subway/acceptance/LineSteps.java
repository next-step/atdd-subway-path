...
public class LineSteps {
    ...
    public static void 지하철_노선_조회_요청_응답(ExtractableResponse<Response> response, Long... 지하철역) {
        assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
        assertThat(response.jsonPath().getList("stations.id", Long.class)).containsExactly(지하철역);
    }
