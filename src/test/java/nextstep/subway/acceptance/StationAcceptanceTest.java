...
import static nextstep.subway.support.fixture.StationFixture.강남역;
import static nextstep.subway.support.fixture.StationFixture.강남역_생성;
import static nextstep.subway.support.fixture.StationFixture.교대역;
...
class StationAcceptanceTest {
    ...
    void createStation() {
        ...
        // then
        assertThat(지하철역_목록_응답에서_역_이름_목록_추출(지하철역_목록_조회_요청())).containsAnyOf(강남역);
    }
    ...
    void getStationList() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            assertThat(지하철역_목록_응답에서_역_이름_목록_추출(지하철역_목록_조회_응답)).containsAnyOf(강남역, 교대역);
        });
    ...
    void deleteStation() {
        ...
        SoftAssertions.assertSoftly(softAssertions -> {
            ...
            assertThat(지하철역_목록_응답에서_역_이름_목록_추출(지하철역_목록_조회_요청())).doesNotContain(강남역);
        });
