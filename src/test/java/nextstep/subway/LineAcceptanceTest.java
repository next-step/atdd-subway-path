...
class LineAcceptanceTest {
    ...
    private static void 노선_등록_결과_검증(ExtractableResponse<Response> 노선, List<String> 예상_스테이션_이름_리스트) {
        노선 = 지하철_노선_조회한다(아이디(노선));
        List<String> 스테이션_이름_리스트 = 스테이션_이름_리스트(노선);
        assertThat(스테이션_이름_리스트).isEqualTo(예상_스테이션_이름_리스트);
    }

    private static void 구간_제거_실패_검증(ExtractableResponse<Response> 노선에서_구간_제거_결과) {
        assertAll(
    ...
    private static void 자하철노선_목록_조회_검증(int 강남역_아이디, int 판교역_아이디, int 사당역_아이디, ExtractableResponse<Response> 신분당선,
    ...
    private static void 지하철노선_생성_검증(int 강남역_아이디, int 판교역_아이디, ExtractableResponse<Response> 등록된_지하철노선) {
        assertAll(
    ...
    private static void 지하철노선_조회_검증(int 강남역_아이디, int 판교역_아이디, int 신분당선_아이디, ExtractableResponse<Response> 조회된_지하철노선) {
        assertAll(
    ...
    private static void 지하철노선_수정_검증(int 수정될_지하철_노선_아이디) {
    ...
    private static void 지하철노선_삭제_검증(int 신분당선_아이디) {
    ...
    private static void 구간_등록_성공_검증(int 강남역_아이디, int 판교역_아이디, int 정자역_아이디, int 신분당선_아이디) {
    ...
    private static void 중간역_제거후_재비치_검증(int 강남역_아이디, int 정자역_아이디, int 신분당선_아이디) {
    ...
    private static void 역_제거_검증(ExtractableResponse<Response> 노선에서_구간_제거_결과, int 노선_아이디, String 제거된_역이름) {
    ...
    private static void 신분당선_판교역_제거_실패_검증(int 신분당선_아이디, ExtractableResponse<Response> 노선에서_구간_제거_결과) {
        var 조회된_신분당선 = 지하철_노선_조회한다(신분당선_아이디);
        assertAll(
                () -> assertThat(노선에서_구간_제거_결과.statusCode()).isEqualTo(
                        HttpStatus.BAD_REQUEST.value()),
