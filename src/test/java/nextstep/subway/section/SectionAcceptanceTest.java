...
public class SectionAcceptanceTest {
    ...
    void deleteSection_deleteUpEnd() {
        ...
        지하철_구간_생성_요청(신분당선_응답.getId(), getDownEndStationId(신분당선_응답),
            또다른지하철역_응답.getId(), 10);

        // when
        지하철_구간_제거_요청(신분당선_응답.getId(), getUpEndStationId(신분당선_응답));
    ...
    void deleteSection_deleteMiddle() {
        ...
        var 또다른지하철역_응답 = 지하철_역_생성_요청(또다른지하철역);
        지하철_구간_생성_요청(신분당선_응답.getId(), getDownEndStationId(신분당선_응답), 또다른지하철역_응답.getId(), 10);
