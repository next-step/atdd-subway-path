...
public class LineServiceTest {
    ...
    void addSection() {
        ...
        Station 수서역 = stationRepository.save(new Station("수서역"));
        LineResponse 분당선 = lineService.saveLine(new LineRequest("분당선", "yello", 태평역.getId(), 가천대역.getId(), 3));
