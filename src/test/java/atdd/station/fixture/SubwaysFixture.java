...
public class SubwaysFixture {
    ...
    public static final Subway NEW_BUNDANG_SUBWAY = new Subway(PANGYO_STATION, NEW_BUNDANG_SUBWAY_LINE);

    public static final List<Subway> SUBWAYS = Arrays.asList(SECOND_SUBWAY, NEW_BUNDANG_SUBWAY);
    public static final List<Subway> SECOND_SUBWAYS = Arrays.asList(SECOND_SUBWAY, YUCKSAM_SUBWAY, SUNLENG_SUBWAY, NEW_BUNDANG_SUBWAY);
