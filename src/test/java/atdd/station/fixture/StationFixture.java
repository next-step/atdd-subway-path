...
public class StationFixture {
    ...
    public static final Station KANGNAM_STATON = new Station(KANGNAM_STATION_NAME);
    ...
    public static final List<Station> KANGNAM_AND_YUCKSAM_STATIONS = new ArrayList<>(Arrays.asList(KANGNAM_STATON, YUCKSAM_STATON));
