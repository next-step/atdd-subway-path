...
public enum SubwayMessage {
    ...
    LINE_NOT_FOUND_MESSAGE(1000L, "존재하지 않는 노선 입니다."),
    SECTION_ADD_STATION_NOT_FOUND_ANYONE_MESSAGE(2000L, "%s와 %s 중 구간을 연결할 역이 모두 없습니다."),
    SECTION_DELETE_LAST_STATION_VALID_MESSAGE(2001L, "마지막 구간만 삭제 할 수 있습니다."),
    ...
    STATION_DELETE_MINIMAL_VALID_MESSAGE(3000L, "역은 %d개 이하일 수 없습니다."),
    STATION_NOT_FOUND_MESSAGE(3001L, "존재하지 않는 역 입니다"),
    STATION_IS_ALREADY_EXIST_IN_LINE_MESSAGE(3002L, "이미 %s과 %s의 구간이 존재합니다.");
