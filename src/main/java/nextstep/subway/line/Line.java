...
import nextstep.subway.line.section.ApplyType;
...
public class Line {
    ...
    public void addSection(Section section) {
        ApplyType applyType = this.sections.add(section);
        this.distance = section.calculateAddDistance(applyType, this.distance);
    }
