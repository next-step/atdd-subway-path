...
public class CannotAddSectionException extends RuntimeException {
    ...
    private static final String INVALID_DISTANCE = "기존 구간의 길이보다 같거나 크면 추가할 수 없습니다. 기존 구간의 길이 : %d, 신규 구간의 길이 : %d";
    ...
    public CannotAddSectionException(int targetDistance, int distance) {
        super(String.format(INVALID_DISTANCE, targetDistance, distance));
    }
}
