...
public class LineController {
    ...
    public ResponseEntity<List<SectionResponse>> getSectionsByLineId(@PathVariable Long lineId) {
        List<SectionResponse> sectionResponses = lineService.getSectionsByLineId(lineId);
