...
---
# Feedback 24.02.17
- [x] JgraphT 라이브러리의 반환값과 최초 의도했던 distance의 타입과 맞추기
- [x] forEach()대신 Java Stream을 활용해보기
- [x] 인수테스트의 주석을 보다 명확하게 하기
- [x] PathFinder의 생성자, shortestPath()의 메서드 인자에 대해 객체 확장성을 고려해 수정해보기
